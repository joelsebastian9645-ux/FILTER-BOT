...
API_ID = int(environ.get('API_ID', '25366739'))
API_HASH = environ.get('API_HASH', 'b346231b70dd0bf8ceadc35564902a20')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8383152919').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002589538346'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002808173110').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002829886296') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-4843037172')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002886671071').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://joelsebastian9645:e1FcaXQRJOcKktkZ@cluster0.rsbntro.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+fOHzroei_nwyMTlh')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+oDrG7H0QtwNjYTMx')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+udXKaHRH9zE0OTNh') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Albertif6r')
